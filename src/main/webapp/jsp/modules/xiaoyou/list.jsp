...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>校友列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="banjimingcheng" id="banjimingchengSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										学院名称
									</label>
									<select name="xueyuanmingcheng" id="xueyuanmingchengSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										学校名称
									</label>
									<select name="xuexiaomingcheng" id="xuexiaomingchengSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
	...
	<script>
		...
		function search(){
			...
			var banjimingchengIndex = document.getElementById("banjimingchengSelect").selectedIndex;
			var banjimingchengOptions = document.getElementById("banjimingchengSelect").options;
			var banjimingchengSelectedOption = banjimingchengOptions[banjimingchengIndex]
			if(banjimingchengSelectedOption.text != null && banjimingchengSelectedOption.text != ''){
				searchForm.banjimingcheng = banjimingchengSelectedOption.text;
			}
			var xueyuanmingchengIndex = document.getElementById("xueyuanmingchengSelect").selectedIndex;
			var xueyuanmingchengOptions = document.getElementById("xueyuanmingchengSelect").options;
			var xueyuanmingchengSelectedOption = xueyuanmingchengOptions[xueyuanmingchengIndex]
			if(xueyuanmingchengSelectedOption.text != null && xueyuanmingchengSelectedOption.text != ''){
				searchForm.xueyuanmingcheng = xueyuanmingchengSelectedOption.text;
			}
			var xuexiaomingchengIndex = document.getElementById("xuexiaomingchengSelect").selectedIndex;
			var xuexiaomingchengOptions = document.getElementById("xuexiaomingchengSelect").options;
			var xuexiaomingchengSelectedOption = xuexiaomingchengOptions[xuexiaomingchengIndex]
			if(xuexiaomingchengSelectedOption.text != null && xuexiaomingchengSelectedOption.text != ''){
				searchForm.xuexiaomingcheng = xuexiaomingchengSelectedOption.text;
			}
			getDataList();
		}		
		// 获取数据列表
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiaoyou/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xiaoyou");
