	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">班级账号</label> 
							<input  name="banjizhanghao" placeholder="班级账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="banjimingcheng" placeholder="班级名称" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">联系人</label> 
							<input  name="lianxiren" placeholder="联系人" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "banjixiaoyou/register";
				$.ajax({ 
					type: "POST",
					url: url,
