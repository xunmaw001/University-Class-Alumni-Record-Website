...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>班级相册列表</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xiangcetupianCell  = document.createElement('td');

				                var xiangcetupianImg = document.createElement('img');
			xiangcetupianImg.setAttribute('src',baseUrl+item.xiangcetupian);
			xiangcetupianImg.setAttribute('height',100);
			xiangcetupianImg.setAttribute('width',100);
			xiangcetupianCell.appendChild(xiangcetupianImg);


			row.appendChild(xiangcetupianCell);
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"banjixiangce");
