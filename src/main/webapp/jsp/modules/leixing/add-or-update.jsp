					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>类型管理</span></li>
								<li class="breadcrumb-item active"><span>编辑类型</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				if(crossrefid && crossuserid) {
					...
					http("leixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("leixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
