	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">学院账号</label> 
							<input  name="xueyuanzhanghao" placeholder="学院账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="xueyuanmingcheng" placeholder="学院名称" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "xueyuanzhuguan/register";
				$.ajax({ 
					type: "POST",
					url: url,
