...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">学院主管管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学院主管管理</span></li>
								<li class="breadcrumb-item active"><span>学院主管列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学院主管列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										学院账号
									</label>
									<input type="text" id="xueyuanzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入学院账号" aria-controls="tableId">
									<label>
										学院名称
									</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#xueyuanzhanghaoSearch').val() != null && $('#xueyuanzhanghaoSearch').val() != ''){
				searchForm.xueyuanzhanghao ="%" +  $('#xueyuanzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xueyuanzhuguan/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				xueyuanzhanghao : searchForm.xueyuanzhanghao,	
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xueyuanzhuguan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("xueyuanzhuguan"+colName,"GET",{
			tableName: "xueyuanzhuguan",
			columnName: colName
		},(res)=>{
			if(res.code == 0){
				return res.data.sum;
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xueyuanzhuguan");
