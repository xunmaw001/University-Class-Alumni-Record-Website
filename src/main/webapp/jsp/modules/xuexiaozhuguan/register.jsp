	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">学校账号</label> 
							<input  name="xuexiaozhanghao" placeholder="学校账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="xuexiaomingcheng" placeholder="学校名称" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "xuexiaozhuguan/register";
				$.ajax({ 
					type: "POST",
					url: url,
