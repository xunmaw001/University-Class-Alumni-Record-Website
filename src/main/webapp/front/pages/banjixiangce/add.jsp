			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div v-if="detail.xiangcetupian" class="layui-input-block">
							<img id="xiangcetupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="baseurl+detail.xiangcetupian">
							<input type="hidden" :value="detail.xiangcetupian" id="xiangcetupian" name="xiangcetupian" />
						</div>
						<div class="layui-input-block">
							<button v-if="!ro.xiangcetupian" type="button" class="layui-btn btn-theme" id="xiangcetupianUpload">
								<i class="layui-icon">&#xe67c;</i>上传相册图片
							</button>
						</div>
					</div>
		            <div class="layui-form-item" pane>
