		...
		<div id="app">
			...
			<div class="forum-container" :style='{"padding":"20px","boxShadow":"0px 0px 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
				<form class="layui-form login-form">
					<div class="layui-form-item layui-form-text" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 0px 0","borderStyle":"solid"}'>
					...
					<div class="layui-form-item layui-form-text l-redio" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 0px 0","borderStyle":"solid"}'>
					...
					<div class="layui-form-item">
						<div class="layui-input-block" style="display: flex;flex-wrap:wrap;">
							...
							<button :style='{"padding":"0 10px","boxShadow":"0 8px 0px rgba(0,0,0,1)","margin":"10px auto","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"rgba(220, 220, 220, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"27px","borderWidth":"1px","width":"10%","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="reset" class="layui-btn layui-btn-primary">重置</button>
						</div>
					</div>
				</form>
			</div>
