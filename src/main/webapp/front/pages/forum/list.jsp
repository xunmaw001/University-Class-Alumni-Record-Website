		...
		<div id="app">
			...
			<div class="forum-container">
				<div class="btn-container" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					...
					<button :style='{"padding":"0 15px","boxShadow":"0 6px 0px rgba(0,0,0,1)","margin":"0 0 0 10px","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"rgba(202, 219, 225, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"27px","borderWidth":"1px","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}'  type="button" class="layui-btn layui-btn-lg btn-theme">
